...
# TODO: set all this in the enviroment variables
basedir = os.path.abspath(os.path.dirname(__file__))
DATABASE_USER = 'akiolisa'
DATABASE_PASSWORD = 'aki12345'
...
ALLOWED_EXTENSIONS = ['txt', 'pdf', 'shp', 'shx', 'dbf', 'lyr', 'prj', 'prg', 
 'jpg', 'png', 'jpeg', 'tif', 'tiff', 'bmp', 'csv', 'zip']
